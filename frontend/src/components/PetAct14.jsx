...
export default function PetAct14() {
  ...
  const startSession = () => {
    ...
    const questionAudio = new Audio('/patr.mp3');
  ...
  return (
    <div style={{
      ...
      <div className="banner-section">
        <img src="/tp14.png" alt="Banner Background" className="banner-img" />
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (your original PetAct14 UI)
            <>
              <div className="question-section">
                <h2 className="question-title">Which part made you feel that way?</h2>
                <div className="answer-field">
                  <label className="field-label">Story Part</label>
                  {!feedback ? (
