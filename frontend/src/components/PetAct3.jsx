...
export default function PetAct3() {
  ...
  // --- STATE MANAGEMENT ---
  // State from your original PetAct3 file
  ...
  // --- AUTOMATION LOGIC (from GodAct2, adapted for PetAct3) ---
  ...
  useEffect(() => {
    ...
    // Using the audio file for Peter Rabbit genre question
    ...
    questionAudio.onended = () => {
      console.log("DEBUG: Peter Rabbit genre question audio finished.");
  ...
  // --- DYNAMIC SUBMIT ANSWER FUNCTION (adapted for PetAct3) ---
  const submitAnswer = async (answer, submissionType) => {
    ...
    try {
      // Using the API endpoint for Peter Rabbit question 3
  ...
  // --- HANDLER FUNCTIONS (adapted for PetAct3) ---
  ...
  return (
    <div style={{
      ...
      <div className="banner-section">
        <img src="/tp3.png" alt="Banner Background" className="banner-img" />
        {showPlayButton && (
          <button className="audio-play-button" onClick={() => new Audio('/genre.mp3').play()}>
            <FaPlay />
          </button>
        )}
      </div>
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (adapted from your original PetAct3 UI)
            <>
              <div className="question-section">
                <h2 className="question-title">What genre is this story?</h2>
