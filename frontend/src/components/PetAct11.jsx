...
export default function PetAct11() {
  ...
  const startSession = () => {
    ...
    const questionAudio = new Audio('/les.mp3');
  ...
  return (
    <div style={{
      ...
      <div className="banner-section">
        <img src="/tp11.png" alt="Banner Background" className="banner-img" />
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (your original PetAct11 UI)
            <>
              <div className="question-section">
                <h2 className="question-title">What lesson did they learn?</h2>
                <div className="answer-field">
                  <label className="field-label">Lesson</label>
                  {!feedback ? (
