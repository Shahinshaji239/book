...
export default function PetAct13() {
  ...
  const startSession = () => {
    ...
    const questionAudio = new Audio('/feel.mp3');
  ...
  return (
    <div style={{
      ...
      <div className="banner-section">
        <img src="/tp13.png" alt="Banner Background" className="banner-img" />
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (your original PetAct13 UI)
            <>
              <div className="question-section">
                <h2 className="question-title">How did you feel while reading?</h2>
                <div className="answer-field">
                  <label className="field-label">Feelings</label>
                  {!feedback ? (
