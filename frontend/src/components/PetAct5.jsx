...
export default function PetAct5() {
  ...
  // --- STATE MANAGEMENT ---
  // State from your original PetAct5 file
  ...
  // --- AUTOMATION LOGIC (from GodAct2, adapted for PetAct5) ---
  ...
  useEffect(() => {
    ...
    // Using the audio file for Peter Rabbit personality question
    ...
    questionAudio.onended = () => {
      console.log("DEBUG: Peter Rabbit personality question audio finished.");
  ...
  const submitAnswer = async (answer, submissionType) => {
    ...
    try {
      // Using the API endpoint for Peter Rabbit question 5
  ...
  // --- HANDLER FUNCTIONS (adapted for PetAct5) ---
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (adapted from your original PetAct5 UI)
            <>
              <div className="question-section">
                <h2 className="question-title">What is Peter Rabbit's personality like?</h2>
