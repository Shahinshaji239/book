...
export default function PetAct6() {
  ...
  // --- STATE MANAGEMENT ---
  // State from your original GodAct2 file
  const [typedAnswer, setTypedAnswer] = useState('');
  const [feedback, setFeedback] = useState(null);
  const [isLoading, setIsLoading] = useState(false);
  const [showAnswer, setShowAnswer] = useState(false);

  // State ported from GodAct1 for the voice workflow
  ...
  // --- AUTOMATION LOGIC (from GodAct2, adapted for PetAct6) ---
  ...
  useEffect(() => {
    ...
    // ADAPTATION: Using the audio file for Peter Rabbit question 6
    const questionAudio = new Audio('/2main.mp3');
    ...
    questionAudio.onended = () => {
      console.log("DEBUG: Peter question 6 audio finished.");
  ...
  // --- DYNAMIC SUBMIT ANSWER FUNCTION (adapted for PetAct6) ---
  const submitAnswer = async (answer, submissionType) => {
    ...
    try {
      // ADAPTATION: Using the API endpoint for Peter question 6
  ...
  // --- HANDLER FUNCTIONS (adapted for PetAct6) ---
  ...
  return (
    <div style={{
      ...
      <div className="banner-section">
        <img src="/tp6.png" alt="Banner Background" className="banner-img" />

        {showPlayButton && (
          <button className="audio-play-button" onClick={() => new Audio('/2main.mp3').play()}>
            <FaPlay />
          </button>
        )}
      </div>
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (adapted for Peter Rabbit)
            <>
              <div className="question-section">
                <h2 className="question-title">What is the second main animal in this story?</h2>
