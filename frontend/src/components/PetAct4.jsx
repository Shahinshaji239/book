...
export default function PetAct4() {
  ...
  // --- STATE MANAGEMENT ---
  // State from your original PetAct4 file
  ...
  // --- AUTOMATION LOGIC (from GodAct2, adapted for PetAct4) ---
  ...
  useEffect(() => {
    ...
    // Using the audio file for Peter Rabbit main animal question
    const questionAudio = new Audio('/1main.mp3');
    ...
    questionAudio.onended = () => {
      console.log("DEBUG: Peter Rabbit characters question audio finished.");
  ...
  // --- DYNAMIC SUBMIT ANSWER FUNCTION (adapted for PetAct4) ---
  const submitAnswer = async (answer, submissionType) => {
    ...
    try {
      // Using the API endpoint for Peter Rabbit question 4
      ...
      if (submissionType === 'voice') {
        speakText(data.message, () => {
          ...
          // Using a placeholder audio for the next prompt
  ...
  // --- HANDLER FUNCTIONS (adapted for PetAct4) ---
  ...
  return (
    <div style={{
      ...
      <div className="banner-section">
        <img src="/tp4.png" alt="Banner Background" className="banner-img" />
        {showPlayButton && (
          <button className="audio-play-button" onClick={() => new Audio('/1main.mp3').play()}>
            <FaPlay />
          </button>
        )}
      </div>
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (adapted from your original PetAct4 UI)
            <>
              <div className="question-section">
                <div className="answer-field">
                  <label className="field-label">Main Animal</label>
                  {!feedback ? (
