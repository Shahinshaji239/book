  ...
  return (
    <div style={{
      ...
      <div className="banner-section">
        <img src="/tp12.png" alt="Banner Background" className="banner-img" />
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (your original PetAct12 UI)
            <>
              <div className="question-section">
                <h2 className="question-title">Who was your favourite character and why?</h2>
                <div className="answer-field">
                  <label className="field-label">Favourite Character</label>
                  {!feedback ? (
