...
export default function PetAct8() {
  ...
  // --- STATE MANAGEMENT ---
  // State from your original PetAct8 file
  ...
  // --- AUTOMATION LOGIC (from GodAct2, adapted for PetAct8) ---
  ...
  useEffect(() => {
    ...
    // ADAPTATION: Using the audio file for Peter Rabbit question 8
    ...
    questionAudio.onended = () => {
      console.log("DEBUG: Peter question 8 audio finished.");
  ...
  };  // --- DYNAMIC SUBMIT ANSWER FUNCTION (adapted for PetAct8) ---
  const submitAnswer = async (answer, submissionType) => {
    ...
    try {
      // ADAPTATION: Using the API endpoint for Peter question 8
  ...
  // --- HANDLER FUNCTIONS (adapted for PetAct8) ---
  const handleTextSubmit = () => {
    if (settingAnswer.trim()) {
      submitAnswer(settingAnswer, 'text');
    }
  };
  ...
  return (
    <div style={{
      ...
      <div className="banner-section">
        <img src="/tp8.png" alt="Banner Background" className="banner-img" />

        {showPlayButton && (
          <button className="audio-play-button" onClick={() => new Audio('/take.mp3').play()}>
            <FaPlay />
          </button>
        )}
      </div>
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (adapted for Peter Rabbit Setting)
            <>
                ...
                <div className="answer-field">
                  ...
                  {!feedback ? (
                    ...
                    <div className="answer-input" style={{ backgroundColor: '#e9ecef', cursor: 'default', minHeight: '55px', padding: '18px 24px' }}>
                      {renderHighlightedText(settingAnswer, feedback.misspelled_words)}
                    </div>
                  )}
                </div>
              </div>
