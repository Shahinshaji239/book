...
export default function PetAct7() {
  ...
  // --- STATE MANAGEMENT ---
  // State from your original PetAct7 file
  ...
  // --- AUTOMATION LOGIC (from GodAct2, adapted for PetAct7) ---
  ...
  useEffect(() => {
    ...
    // ADAPTATION: Using the audio file for Peter Rabbit question 7
    const questionAudio = new Audio('/p1.mp3');
    ...
    questionAudio.onended = () => {
      console.log("DEBUG: Peter question 7 audio finished.");
  ...
  // --- DYNAMIC SUBMIT ANSWER FUNCTION (adapted for PetAct7) ---
  const submitAnswer = async (answer, submissionType) => {
    ...
    try {
      // ADAPTATION: Using the API endpoint for Peter question 7
  ...
  // --- HANDLER FUNCTIONS (adapted for PetAct7) ---
  const handleTextSubmit = () => {
    if (personalityAnswer.trim()) {
      submitAnswer(personalityAnswer, 'text');
    }
  };
  ...
  return (
    <div style={{
      ...
      <style>
        {`
         ...
         @keyframes spin {
          ...
          /* RESPONSIVE DESIGN - SAME AS PETACT6 */
      ...
      <div className="banner-section">
        <img src="/tp7.png" alt="Banner Background" className="banner-img" />
        {showPlayButton && (
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (adapted for Peter Rabbit Personality)
            <>
              <div className="question-section">
                <h2 className="question-title">What is Peter Rabbit's personality?</h2>
                <div className="answer-field">
                  ...
                  {!feedback ? (
                    ...
                    <div className="answer-input" style={{ backgroundColor: '#e9ecef', cursor: 'default', minHeight: '55px', padding: '18px 24px' }}>
                      {renderHighlightedText(personalityAnswer, feedback.misspelled_words)}
                    </div>
                  )}
                </div>
              </div>
