...
export default function PetAct10() {
  ...
  const startSession = () => {
    ...
    const questionAudio = new Audio('/sol.mp3');
  ...
  return (
    <div style={{
      ...
      <div className="banner-section">
        <img src="/tp10.png" alt="Banner Background" className="banner-img" />
      ...
      <div className="main-content">
        ...
        <div className="content-with-button">
          ...
          {interactionStage === 'voice' ? (
            ...
            // UI for text input stage (your original PetAct10 UI)
            <>
              <div className="question-section">
                <h2 className="question-title">How was it solved?</h2>
